...
public class BinarySearchTrees {
    ...
    //for sorted display of BST inorder will give it
    public void sorted()
    {
        sorted(root);
    }
    ...
    //also pre order transversal can be used

//    public void makefromsorted(int[] ar)
//    {
//        makefromsorted(ar,0,ar.length-1,root);
//    }
